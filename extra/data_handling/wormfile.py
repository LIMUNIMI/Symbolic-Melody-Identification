            ...
            while line:
                ...
                if m:
                    ...
                    try:
                        ...
                        print(u'Error: Unknown header attribute at line "{0}"'.format(line))
                        return False
                    except ValueError:
                        print(u'Error: Invalid attribute value at line "{0}"'.format(line))
                        return False
                    ...
                    print(u'Error reading WORM file header at line "{0}"'.format(line))
                    return False
